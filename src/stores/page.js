        ...
        sections: [
            {
                ...
                title: "",
                emptyText: 'No data found',
                definition: { label: 'name', value: 'code', dataSource: 'abc/xyz' },
                actionItems:[]
            },
            {
                type: 'form', 
                ...
                emptyText: 'No data found',
                actionItems: [
                    { label: 'Save', action: 'save', disabled: false, icon: 'save', submit: true, event: { id: 12, name: 'api', target: 'post|langugae/save' } },
                    { label: 'Deactivate', action: 'deactivate', disabled: false, icon: 'deactivate', submit: false, api: { type: 'api', target: 'delete|language/delete' } },
