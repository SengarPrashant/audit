export const UserManagementIcon = ({ w = 16, h = 16, className = '', color = 'grey', style = {} }) => {
    return <svg  fill={color} width={w} height={h} className={className} style={style} viewBox="0 0 32 32" version="1.1">
    <title>user</title>
